        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 w-[95%] sm:w-full mx-auto px-1 sm:px-0 justify-items-center sm:justify-items-stretch">
          ...
          <div className="px-0 sm:px-0 w-[98vw] sm:w-full max-w-[98vw] sm:max-w-none mx-auto">
            <div className="bg-white/90 backdrop-blur-sm rounded-3xl shadow-2xl overflow-hidden h-full min-h-[600px] border border-white/50 hover:shadow-3xl transition-all duration-300 w-full max-w-[98vw] sm:max-w-none mx-auto">
              <div className="p-4 sm:p-8 border-gradient-to-r from-indigo-100 to-purple-100">
                       <div className="flex items-center space-x-3 mb-2">
                  <div className="w-1 h-8 bg-gradient-to-b from-blue-500 to-cyan-500 rounded-full"></div>
                  <div className="flex items-center">
                    <h3 className="text-2xl font-bold text-gray-900 hidden sm:block">📅 Book a 30 Minute Meeting </h3>
                     <h3 className="text-[18px] font-bold text-gray-900 block lg:hidden"> Book a 30 Minute Meeting </h3>
                    <div className="flex items-center space-x-3 ml-4 ">
                      <div className="inline-flex items-center space-x-2 animated-gradient-btn rounded-full px-3 py-1 backdrop-blur-sm animate-blink-pulse">
                        <div className="w-2 h-2 bg-white rounded-full animate-pulse"></div>
                        <span className="text-sm font-medium text-white">Limited</span>
                      </div>
                    </div>
                  </div>
