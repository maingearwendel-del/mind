...
const TestimonialsGoogle: React.FC<TestimonialsGoogleProps> = ({ 
          ...
          <div className="grid lg:grid-cols-2 gap-0 items-center justify-center min-h-[20vh] mt-12">
            ...
            <div className="relative lg:ml-20">
              <div className="mb-0  mt-12">
                <div className="relative flex flex-col items-center lg:items-start">
                  ...
                  <h3 className="relative text-6xl lg:text-4xl font-black text-gray-900 mb-4 leading-none">
                    <span className="block  transform hover:scale-105 transition-transform duration-300 text-[#3d3d3d]">
                     ...
                     <span className="absolute top-[-20px] -left-14 text-8xl font-black text-blue-400  opacity-80 select-none pointer-events-none -z-10">"</span>
                      My Site <br className="block lg:hidden" /> Actually Brings in
                    </span>
                    <span className="block bg-gradient-to-r from-blue-600 via-cyan-600 to-blue-600 bg-clip-text text-transparent animate-gradient-x bg-300% font-black transform hover:scale-110 transition-all duration-500 drop-shadow-2xl leading-none pb-4 relative z-10" style={{ fontSize: 'calc(6rem - 15px)' }}>

                      Bookings & Sales Now <span className="inline-block animate-wobble text-[65px] !text-black !transition-none" style={{ color: '#000' }}>🤑</span>
                     {/* Closing quote mark - positioned right after the d */}
                     <span className="absolute lg:right-[25px] lg:top-[50px] right-100 top-0 text-8xl font-black text-blue-400 opacity-80 select-none pointer-events-none -z-10 translate-x-[-30px] sm:translate-x-0 translate-y-[40px] sm:translate-y-0">"</span>
                    </span> 
                  </h3>
              ...
              >
              <span className="font-semibold text-[16px] z-50"><span className="font-semibold">Get your own <img src="/WordPress_logo.svg" alt="Wordpress Logo" description="Build your site with Wordpress" className="h-5 inline-block align-middle ml-1 -translate-y-0.5" /> Site</span></span> 
                <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
              </button></div>
        
                  {/* Decorative elements */}
                  <div className="absolute -top-8 -right-8 w-12 h-12 bg-gradient-to-br from-blue-400 to-cyan-400 rounded-full opacity-20 blur-xl animate-float"></div>
                  <div className="absolute -bottom-4 -left-4 w-8 h-8 bg-gradient-to-br from-cyan-400 to-blue-400 rounded-full opacity-15 blur-lg animate-float" style={{ animationDelay: '1s' }}></div>
                </div>
              </div>
            </div>
            ...
            <div className="relative"> 
              <div className="max-w-xl bg-white rounded-[60px] p-4 sm:p-5 sm:pl-8 shadow-xl border border-gray-200 mx-2 sm:mx-0">
                <blockquote className="text-gray-700 text-lg lg:text-xl leading-relaxed italic mb-6 border-l-4 border-blue-500 pl-6  mt-4 ml-3 font-semibold">
                ...
                <div className="flex items-center gap-4 -mt-4 mb-4 ml-[7px] lg:ml-0">
                  {/* Hugo S. Image */}
                  <div className="relative flex-shrink-0">
                    {/* Floating pill centered on image */}
                    <div className="absolute -bottom-2 left-1/2 transform -translate-x-1/2 bg-gradient-to-r from-blue-500 to-indigo-600 text-white px-2 py-0.2 rounded-full text-sm font-semibold shadow-lg z-10 whitespace-nowrap hover:scale-110 transition-transform duration-300 ml-[7px] lg:ml-0"> 
                      Checo
                    </div>
                    <div className="relative w-20 h-20 rounded-full overflow-hidden border-4 border-white shadow-lg group hover:scale-110 transition-transform duration-300 ml-[13px] lg:ml-0">
                      <img 
                        src="/checo_thumbnail2.webp"
                        alt="Stache Barbershop Success story"
                        className="w-full h-full object-cover group-hover:opacity-0 "
                      />
                      <img 
                        src="/checo_thumbnail_hover.webp"
                        alt="Stache Barbershop Success story - Hover"
...
<div class="grid grid-cols-1 md:grid-cols-[44%_28%_28%] gap-3 hidden lg:flex">
  {/* Column 1 */}
  <div class="p-2 ">
 ...
 {/* Column 2 */} 
  ...
  <div class="p-2 flex items-center justify-center">
    <div><span className="text-gray-600 font-bold  sm:mt-0 "><img 
                      src="/stache_barbers_sb_logo.webp"
                      alt="Stache Barbers Logo"
                      className="lg:w-15 w-[70px] h-17 ml-3 animate-wobble"  
                    /></span></div>
  </div>
...
export default TestimonialsGoogle;