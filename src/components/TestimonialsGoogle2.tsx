...
interface TestimonialsGoogle2Props {
  themeClasses?: {
    text: string;
...
const TestimonialsGoogle2: React.FC<TestimonialsGoogle2Props> = ({ 
  ...
  return (
    <section className="pt-0 lg:pt-4 mb-16 lg:mb-0 lg:pb-10 mt-0 bg-white relative overflow-hidden">
            ...
            <div className="relative ml-[50px] ">
              <div className="mb-0  mt-12"> 
                <div className="relative"> 
                  ...
                  <h3 className="relative text-4xl lg:text-6xl font-black text-gray-900 mb-4 leading-none lg:ml-[49px]">
                    <span className="block  transform hover:scale-105 transition-transform duration-300 text-[#3d3d3d]  ">
                     ...
                     <span className="absolute top-[-20px] -left-[50px] lg:-left-[65px]  text-8xl font-black text-purple-400 opacity-80 select-none pointer-events-none -z-10">"</span>
                      Wendel is a<span className="sm:hidden">...</span><span className="hidden sm:inline-block animate-bounce-up-down">🧙‍♂️</span>
                    </span>
                                 
                    <span className=" block bg-gradient-to-r from-purple-600 via-indigo-600 to-purple-600 bg-clip-text text-transparent animate-gradient-x bg-300% font-black transform hover:scale-110 transition-all duration-500 drop-shadow-2xl leading-none pb-4 relative z-10" style={{ fontSize: 'calc(8rem - 15px)' }}>
                    <span className=" -left-[40px] lg:-left-[0px] block bg-gradient-to-r from-purple-600 via-indigo-600 to-purple-600 bg-clip-text text-transparent animate-gradient-x bg-300% font-black transform hover:scale-110 transition-all duration-500 drop-shadow-2xl leading-none pb-4 relative z-10 text-[70px] lg:text-[100px]">
                      WIZARD  
                     {/* Closing quote mark - positioned right after the d */}
                    <span className="absolute -right-[65px] lg:right-[50px] -top-[50px] lg:-top-[0px] text-8xl font-black text-purple-400 opacity-80 select-none pointer-events-none -z-10 translate-x-[-30px] sm:translate-x-0 translate-y-[40px] sm:translate-y-0">"</span>  
                    </span> 
                    </span>
 ...
 <img  
                      src="/wizard-dance.gif" 
                      alt="Wendel The Wizard"
                         className="w-[250px] h-[150px]  rounded-[30px]  lg:w-[200px] lg:hidden mb-10"
                    />
...
export default TestimonialsGoogle2;